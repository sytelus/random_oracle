...
if __name__ == "__main__":
    ...
    for model in models:
        ...
        run_method_tests(
            ...
            temperature=0.9,
            top_p=1.0,
            output_dir="openended_qa_coverageqa_test",
            # output_dir="openended_qa_coverageqa",
            num_workers=16 if any(x in model_basename for x in ["claude", "gemini", "llama"]) else 32,
        )
